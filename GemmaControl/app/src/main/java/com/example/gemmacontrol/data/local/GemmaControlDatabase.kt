    ...
    companion object {
        ...
        val MIGRATION_1_2 = object : Migration(1, 2) {
            override fun migrate(db: SupportSQLiteDatabase) {
                // 1. Create temporary tables representing the hardened v2 schema
                db.execSQL("""
                ...
                // 2. Migrate existing v1 plaintext data with Keystore-backed GCM-encryption and HMAC hashing
                val cipher = com.example.gemmacontrol.data.crypto.AndroidKeystoreSensitiveTextCipher()
                val tokenGen = com.example.gemmacontrol.data.crypto.AndroidKeystoreHmacDedupeTokenGenerator()
                ...
                // 3. Drop v1 legacy tables and rename v2 tables
