...
- **Safety Routing**: Tool execution safety is deterministic in V1. See [ASSISTANT_SAFETY_POLICY.md](ASSISTANT_SAFETY_POLICY.md) for read-only, local-write, open-app, send, delete, media-analysis, and ShieldGemma gate decisions.
