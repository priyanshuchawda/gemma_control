...
- `ai/tools/WhatsAppLocalToolExecutor.kt` — Executes confirmed local-only tool decisions for capture pause/resume, recent local message reads, local message search/details, actionable inbox reads, follow-ups, priority flags, reminders, and scoped local data deletion
